  ...
  return (
    <Container>
      ...
      <div id="coaching-page-bio">
        ...
        <p>Currently, I can be found working out at <a href="ironboundperformanceathletics.com">Ironbound Performance Athletics</a>, where I also coach a couple classes each week. It's a fantastic, tight-knit community; the fact that I've gotten in much better shape since joining just feels like a bonus. Come visit us in Jersey City, NJ!</p>
      </div>

      <Container id="coaching-services-section">
        <h2 id="coaching-services-header">Services</h2>
        <p><b>Please send all training inquiries to <a href="acooksey.hp@gmail.com">acooksey.hp@gmail.com</a>. Thank you!</b></p>
      ...
      <Container id="coaching-philosophy-section">
        ...
        <h3>Skill Development Over Quick Fixes</h3>
        <p>
